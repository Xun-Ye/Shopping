...
public class WebSocket {
    ...
    /**
     	* 存储当前用户联系人
     */
    private Map<String,WebSocket> contacts = new ConcurrentHashMap<String, WebSocket>();
    
    public Map<String, WebSocket> getContacts() {
		return contacts;
	}

	public void setContacts(Map<String, WebSocket> contacts) {
...
//            logger.info("来自客户端消息：" + message+"客户端的id是："+session.getId());
            ...
            }else if(jsonObject.containsKey("type") && jsonObject.getIntValue("type")==2){
